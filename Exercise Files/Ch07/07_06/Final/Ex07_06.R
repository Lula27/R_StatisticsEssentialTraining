...
n5 <- c(rep(100, 5)) # repeat 100, 5X
n5
# Another specifies the number of people who are in category
# Same as "number of successes"
x5 <- c(65, 60, 60, 50, 45)
prop.test(x5, n5) # retreives Chi-square and p-values - 0.02704 (statistically significant evidence to reject ho that the proportions are equal)
